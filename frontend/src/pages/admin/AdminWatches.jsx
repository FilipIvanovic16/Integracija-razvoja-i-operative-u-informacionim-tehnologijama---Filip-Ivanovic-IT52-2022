          ...
          <div className="modal modal-wide" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={save}>
                    ...
                    <button
                      ...
                      onClick={() =>
                        setForm((prev) => ({
                          ...prev,
                          condition:
                            prev.condition === 'NEW' || prev.condition === ''
                              ? 'VERY_GOOD'
                              : prev.condition,
                        }))
                      }
              ...
              <div className="form-row">
                ...
                <div className="field">
                  <label>Prečnik (mm)</label>
                  <input
                    className="input"
                    type="number"
                    value={form.caseDiameterMm}
                    onChange={set('caseDiameterMm')}
                  />
                </div>
              </div>
              <div className="form-row">
                <div className="field">
                  <label>Vodootpornost (m)</label>
                  <input
                    className="input"
                    type="number"
                    value={form.waterResistanceM}
                    onChange={set('waterResistanceM')}
                  />
                </div>
              </div>
              <div className="field">
