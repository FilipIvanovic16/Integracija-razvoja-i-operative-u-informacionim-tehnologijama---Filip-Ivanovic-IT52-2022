        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/error")
                    ...
                    .permitAll()
                    .requestMatchers(
                        HttpMethod.GET, "/api/watches/**", "/api/brands/**", "/api/categories/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/uploads/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.PATCH, "/api/watches/*/stock")
                    .hasAnyRole("ADMIN", "SERVICE")
                    .requestMatchers(
                        HttpMethod.POST, "/api/watches/**", "/api/brands/**", "/api/categories/**")
                    .hasRole("ADMIN")
                    .requestMatchers(
                        HttpMethod.PUT, "/api/watches/**", "/api/brands/**", "/api/categories/**")
                    .hasRole("ADMIN")
                    .requestMatchers(
                        HttpMethod.DELETE,
                        "/api/watches/**",
