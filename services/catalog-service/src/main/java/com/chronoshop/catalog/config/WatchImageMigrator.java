...
/**
 * Legacy migracija iz doba monolita (kad je Watch imao samo jedno imageUrl polje). Na svezoj bazi
 * (posle Flyway + seeder-a) nema sta da migrira - ostaje kao bezbedan no-op.
 */
@Component
@Order(10)
public class WatchImageMigrator implements CommandLineRunner {
  ...
  public WatchImageMigrator(
      WatchRepository watchRepository, WatchImageRepository watchImageRepository) {
