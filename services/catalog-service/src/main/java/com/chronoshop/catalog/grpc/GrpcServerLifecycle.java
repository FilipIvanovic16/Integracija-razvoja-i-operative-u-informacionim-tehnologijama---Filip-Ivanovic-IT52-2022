...
/**
 * Manuelno pokretanje gRPC servera (bez treceg-lica starter zavisnosti) uz Spring-ov
 * lifecycle - server kreze posle context refresh-a i gasi se uredno na shutdown.
 */
@Component
public class GrpcServerLifecycle implements SmartLifecycle {
    ...
    public GrpcServerLifecycle(@Value("${grpc.server.port:9082}") int port, StockGrpcService stockGrpcService) {
        this.port = port;
