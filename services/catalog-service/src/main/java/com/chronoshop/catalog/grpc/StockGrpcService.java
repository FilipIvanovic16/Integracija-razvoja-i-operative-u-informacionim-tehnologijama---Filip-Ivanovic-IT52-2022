 ...
 * feat/order-service). Poslovni ishodi (nije pronadjen, nedovoljno na stanju) se vracaju
 * u samom odgovoru (found=false / success=false), ne kao gRPC status greske - vidi
 * napomenu u stock.proto.
 */
@Component
public class StockGrpcService extends StockServiceGrpc.StockServiceImplBase {
    ...
    public void checkStock(StockCheckRequest request, StreamObserver<StockCheckResponse> responseObserver) {
        ...
        try {
            ...
            response = StockCheckResponse.newBuilder()
                    .setFound(true)
    ...
    public void reserveStock(StockReserveRequest request, StreamObserver<StockReserveResponse> responseObserver) {
        ...
        try {
            ...
            response = StockReserveResponse.newBuilder()
                    .setSuccess(true)
