...
/**
 * Seeduje demo katalog (satovi, brendovi, kategorije). Deo korisnika iz starog
 * DataSeeder-a ide u auth-service (AuthDataSeeder).
 */
@Component
...
public class CatalogDataSeeder implements CommandLineRunner {
    ...
    public CatalogDataSeeder(BrandRepository brandRepository, CategoryRepository categoryRepository,
