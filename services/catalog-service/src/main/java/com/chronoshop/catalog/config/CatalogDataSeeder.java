...
/**
 * Seeduje demo katalog (satovi, brendovi, kategorije). Deo korisnika iz starog DataSeeder-a ide u
 * auth-service (AuthDataSeeder).
 */
@Component
...
public class CatalogDataSeeder implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    log.info(
        "Seed: ubačeno {} satova, {} brendova, {} kategorija.",
