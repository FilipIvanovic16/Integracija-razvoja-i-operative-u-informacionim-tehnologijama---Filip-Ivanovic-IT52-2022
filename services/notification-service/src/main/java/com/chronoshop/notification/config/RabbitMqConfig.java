 ...
 * (order.created, payment.completed, payment.failed) - samo cita, nista ne publikuje. Isti DLX/DLQ
 * obrazac kao order-service i payment-service (feat/rabbitmq-events).
 */
@Configuration
