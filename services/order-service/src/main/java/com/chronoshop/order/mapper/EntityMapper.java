...
/**
 * Mapiranje order-service entiteta (Order, OrderItem, WishlistItem) u DTO odgovore. Za razliku od
 * monolita, Order/OrderItem/WishlistItem vise nemaju JPA relacije ka User/Watch (druge baze), pa se
 * koriste snimljena polja odnosno prosledjeni DTO dobijen REST pozivom ka catalog-service (za
...
public final class EntityMapper {
  ...
  public static WishlistItemResponse toWishlistItemResponse(
      WishlistItem item, WatchResponse watch) {
