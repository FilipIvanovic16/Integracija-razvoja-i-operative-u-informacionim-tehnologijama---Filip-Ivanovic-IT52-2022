...
/**
 * REST klijent ka catalog-service - proverava/rezerviše zalihe pre kreiranja porudžbine. Zameniće
 * ga gRPC CheckStock/ReserveStock (feat/grpc-stock-check); ova REST putanja ostaje kao fallback pri
 * nedostupnosti gRPC servera, po specifikaciji. Poziv rezervacije se identifikuje kao "SERVICE"
 * (X-User-Roles), ne kao konkretan korisnik.
 */
@Component
public class CatalogClient {
  ...
  public CatalogClient(
      RestClient.Builder builder, @Value("${app.catalog-service.url}") String baseUrl) {
