...
/**
 * Zamenjuje REST poziv koji je payment-service ranije radio (feat/payment-service PR)
 * da bi javio order-service-u novi status - sada to ide asinhrono preko RabbitMQ,
 * kako specifikacija zahteva.
 */
@Component
public class PaymentEventListener {
    ...
    public void onPaymentFailed(PaymentFailedEvent event) {
        log.info("Primljen payment.failed za porudžbinu {} - status -> CANCELLED.", event.orderNumber());
