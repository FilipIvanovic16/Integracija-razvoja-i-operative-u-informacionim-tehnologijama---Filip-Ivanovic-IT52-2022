...
/**
 * Lista zelja ulogovanog korisnika. Ostaje na istoj putanji kao u monolitu
 * (/api/account/wishlist) da frontend ne mora da se menja - gateway (PR
 * feat/api-gateway) rutira ovu putanju ka order-service, a /api/account/me i
 * /api/account/addresses/** ka auth-service.
 */
@RestController
