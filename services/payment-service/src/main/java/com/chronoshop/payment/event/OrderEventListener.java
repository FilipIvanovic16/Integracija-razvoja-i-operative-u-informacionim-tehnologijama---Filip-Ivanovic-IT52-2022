...
/**
 * Eagerly kreira Payment "stub" (status REQUIRES_PAYMENT) cim je porudzbina kreirana, pre nego sto
 * kupac uopste pokrene checkout. Admin pregled transakcija time vidi porudzbinu odmah;
 * PaymentService.createPaymentIntent kasnije nadje ovaj isti red preko findByOrderId umesto da
 * pravi novi.
 */
@Component
public class OrderEventListener {
  ...
  public void onOrderCreated(OrderCreatedEvent event) {
    ...
    log.info(
        "Primljen order.created - kreiran payment stub za porudžbinu {}.", event.orderNumber());
  }
}
