...
/**
 * Mapiranje Payment entiteta u DTO odgovor. Za razliku od monolita, orderNumber i customerName ne
 * dolaze sa JPA relacije ka Order (druga baza) vec su snimljeni na samom Payment-u u trenutku
 * kreiranja placanja.
 */
