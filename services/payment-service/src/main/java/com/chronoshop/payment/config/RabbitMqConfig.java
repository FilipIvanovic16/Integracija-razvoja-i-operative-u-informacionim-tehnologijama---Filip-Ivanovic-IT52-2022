...
/**
 * payment-service konzumira order.created (eagerly kreira Payment "stub" da admin
 * pregled transakcija vidi porudzbinu i pre nego sto kupac krene na plaćanje) i
 * publikuje payment.completed/payment.failed na istu topic razmenu.
 */
@Configuration
public class RabbitMqConfig {
    ...
    public Binding orderCreatedBinding(Queue orderCreatedQueue, TopicExchange chronoShopEventsExchange) {
        return BindingBuilder.bind(orderCreatedQueue).to(chronoShopEventsExchange)
