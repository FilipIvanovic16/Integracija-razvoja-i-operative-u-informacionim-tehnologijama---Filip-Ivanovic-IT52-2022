...
/**
 * Seeduje demo naloge (admin@chronoshop.rs, kupac@chronoshop.rs) koji moraju da rade i posle
 * dekompozicije monolita. Deo kataloga iz starog DataSeeder-a ide u catalog-service.
 */
@Component
...
public class AuthDataSeeder implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    log.info(
        "Seed: kreirani nalozi admin@chronoshop.rs / Admin123! i kupac@chronoshop.rs / Kupac123!");
  }
}
