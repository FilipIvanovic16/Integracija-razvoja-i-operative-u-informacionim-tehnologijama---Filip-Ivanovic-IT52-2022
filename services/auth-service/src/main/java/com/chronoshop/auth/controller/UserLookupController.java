...
/**
 * Interni lookup za ostale servise (npr. order-service validira korisnika i razresava
 * adresu isporuke pre kreiranja porudzbine). Nema JWT ovde - security/* ostaje samo u
 * auth-service, a gateway (PR feat/api-gateway) ce kasnije ograniciti ko sme da pogodi
 * ove rute spolja. Podaci koji se vracaju nisu osetljivi (bez lozinke).
 */
@RestController
