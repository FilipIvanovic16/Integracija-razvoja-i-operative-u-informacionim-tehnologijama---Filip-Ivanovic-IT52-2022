...
/**
 * Globalno rukovanje izuzecima (@ControllerAdvice) — klijent uvek dobija
 * uniforman, bezbedan JSON odgovor bez otkrivanja internih detalja sistema.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleValidation(MethodArgumentNotValidException ex, HttpServletRequest req) {
        ...
        ApiError error = ApiError.of(HttpStatus.BAD_REQUEST.value(), "Validation Failed",
                "Zahtev sadrži nevalidne podatke.", req.getRequestURI(), fieldErrors);
    ...
    public ResponseEntity<ApiError> handleGeneric(Exception ex, HttpServletRequest req) {
        return build(HttpStatus.INTERNAL_SERVER_ERROR,
                "Došlo je do neočekivane greške. Pokušajte ponovo kasnije.", req);
    }
